                ...
                <div class="flexslider">
                    ...
                    <ul class="slides">
                        ...
                        <li>
                            <blockquote>
                                <p class="about">
                                    این سایت به منظور تسهیل دسترسی به هزاران برنامه موجود در ftp دانشگاه علم و صنعت ایران توسط دفتر فرهنگی دانشکده کامپیوتر ایجاد شده است.
                                    <br>
                                    شما می توانید با استفاده از قسمت جست و جو یا مراجعه به قسمت گروه ها برنامه مورد نظر خود را دانلود نمایید.
                                </p>
                            </blockquote>
                        </li> <!-- slide ends -->
                        ...
                        <li>
                            <blockquote>
                                <p class="about">
                                    برنامه های موجود در ftp به تازگی به روز رسانی شده اند و سعی شده تا جدید ترین نسخه آن ها در سایت قرار گیرد.
                                    <br>
                                    در صورتی که برنامه موردنظر خود را نیافتید, نام برنامه را از طریق فرم ارتباط با ما ارسال کنید تا در اسرع وقت در سایت قرار گیرد.
                                </p>
                            </blockquote>
                        </li> <!-- slide ends -->
...
<section id="contact">
    ...
    <div class="row section-head">
        ...
        <div class="ten columns">
            ...
            <p class="lead">برای ارسال انتقادات و پیشنهادات از فرم زیر استفاده کنید.<br>در صورت ارایه اطلاعات تماس با شما ارتباط خواهیم بود.
            </p>
